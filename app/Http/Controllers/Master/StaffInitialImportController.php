...
class StaffInitialImportController extends Controller
{
    ...
    private function templateSpreadsheet(): Spreadsheet
    {
        ...
        $sheet->fromArray([
            ...
            [null, '佐藤 太郎', '社員', '2026/04/01', null, '46', '2026/04/01', null, null, null, null, null, null, null, null, null, null, null, null],
        ], null, 'A2');
        ...
        $guide->fromArray([
            ...
            ['5. 日付はYYYY-MM-DD、YYYY/MM/DD、Excel日付セルのいずれも使用できます。金額は0以上の整数、扶養人数の空欄は0人として登録されます。'],
